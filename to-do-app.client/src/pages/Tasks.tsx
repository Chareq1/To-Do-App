                                                                ...
                                                                <div className="flex items-center gap-2 w-full">
                                                                    <span className="flex items-center gap-2">
                                                                        <button
                                                                            ...
                                                                            onClick={() => updateTaskStatus(task.taskId, task.status === 2 ? 0 : 2)}
                                                                            title={task.status === 2 ? 'Oznacz jako niezrobione' : 'Oznacz jako zrobione'}
                                                                        >
                                                                    ...
                                                                    <span className="flex items-center">
                                                                        <AlertCircle className={`w-4 h-4 ${task.priority === 2
                                                                            ? 'text-red-500'
                                                                            : task.priority === 1
                                                                                ? 'text-yellow-500'
                                                                                : 'text-green-500'
                        ...
                        <div>
                            <form
                                onSubmit={async (e) => {
                                    ...
                                    const combinedDueDate = newDueDate && newDueTime ? `${newDueDate}T${newDueTime}:00Z` : null;
                                ...
                                <div className="mt-5">
                                    ...
                                    <div className="flex gap-2">
                                        <input
                                            ...
                                            readOnly="true"
                                            name="dueDate"
                                            defaultValue={panelData?.dueDate?.split('T')[0]}
                                            className="border-[#2775EE] border-2 pl-5 h-12 md:text-sm lg:text-base rounded-full bg-[#4a4a4a] text-[#e8e8e8] w-1/2"
                                        />
                                        <input
                                            type="time"
                                            readOnly="true"
                                            name="dueTime"
                                            defaultValue={panelData?.dueDate?.split('T')[1]?.slice(0, 5)}
                                            className="border-[#2775EE] border-2 pl-5 h-12 md:text-sm lg:text-base rounded-full bg-[#4a4a4a] text-[#e8e8e8] w-1/2"
                                        />
                                    </div>
                                </div>
                        ...
                        <div>
                            <form
                                onSubmit={async (e) => {
                                    ...
                                    const combinedDueDate = updatedDueDate && updatedDueTime ? `${updatedDueDate}T${updatedDueTime}:00Z` : null;
                                    ...
                                    if (combinedDueDate !== panelData.dueDate) {
